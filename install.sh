#!/bin/sh
# install.sh — put the ClickUp CLI on the PATH by linking it into ~/.local/bin.
#
...
# Prerequisites. None of these stop the installation: the CLI degrades to a clear
